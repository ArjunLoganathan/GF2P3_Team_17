...
\author{
Team Number: \textit{17}\\
\textit{Arjun Loganathan (al2190)}\\
\textit{Bill Leoutsakos (vl346)}\\
...
\begin{itemize}
    \item \textbf{Arjun Loganathan: Language, scanner, and names}
    ...
    \item \textbf{Shi Tan Li: Parser and network construction}
    ...
    \item \textbf{Bill Leoutsakos: GUI, integration, and release packaging}
...
grammar. Comments will be intercepted and dismissed by the scanner. A comment begins with \textbackslash* and ends with *\textbackslash. 
...
\texttt{ERR\_220} & Semantic & \texttt{*** Error 220: Open Circuit Error. Network structural synthesis layout contains unconnected input gates.} \\ \addlinespace
